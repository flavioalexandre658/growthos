          ...
          {cohorts.map((cohort) => {
            const retentionRate =
              cohort.totalCustomers > 0
                ? Math.round((cohort.activeCount / cohort.totalCustomers) * 100)
                : 0;
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <div
                        className="h-1.5 rounded-full bg-indigo-500/30 relative overflow-hidden"
                    ...
                    <div className="flex items-center gap-3 text-[10px] text-zinc-600">
                      <span className="flex items-center gap-0.5">
                        <IconUsers size={9} />
                        {cohort.totalCustomers} {t("cohorts.total").toLowerCase()}
                      </span>
                      <span className="flex items-center gap-0.5 text-emerald-600">
                        <IconUserCheck size={9} />
                        {cohort.activeCount} {t("cohorts.active").toLowerCase()}
                      </span>
                      ...
                      {expandedCustomers.map((c) => (
                        ...
                        >
                          <div className={cn(
                            ...
                            c.isActive ? "bg-emerald-500/15 text-emerald-400" : "bg-zinc-800 text-zinc-600"
                          )}>
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            <span className={cn(
                              ...
                              {c.isActive ? t("cohorts.active") : t("cohorts.churned")}
                            </span>
                            {c.ltvInCents > 0 && (
