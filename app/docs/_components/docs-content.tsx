        ...
        <div className="max-w-4xl px-8 py-6 pb-20">
          ...
          <TabsContent value="dedup" className="mt-0 space-y-6">
            ...
            <Callout type="warn">
              ...
              O tracker envia automaticamente <Mono>dedupe_id</Mono> ao servidor, que gera um hash SHA256 deterministico —
              garantindo dedup perfeito independente de reloads, novas abas ou visitas futuras.
              Sem <Mono>dedupe_id</Mono>, o servidor usa um hash de fallback com janela diaria (24h) e retorna{" "}
              <Mono>X-GrowthOS-Warning</Mono> no header.
            </Callout>
          </TabsContent>
