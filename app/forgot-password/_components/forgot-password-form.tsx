    ...
    return (
      <div className="space-y-4 text-center">
        ...
        <div className="space-y-1">
          <h3 className="text-base font-semibold text-zinc-100">Email enviado</h3>
          <p className="text-sm text-zinc-500">
            Se <strong className="text-zinc-300">{getValues("email")}</strong> tem
            uma conta, você receberá as instruções em breve.
          </p>
        </div>
