...
interface PublicRevenueChartProps {
  data: IPublicRevenueEntry[];
  currency: string;
  locale: string;
}
...
export function PublicRevenueChart({ data, currency, locale }: PublicRevenueChartProps) {
    ...
    <div className="rounded-xl border border-zinc-800/80 bg-zinc-900/40 p-4 sm:p-5">
      ...
      <ResponsiveContainer width="100%" height={140}>
        <AreaChart data={formatted} margin={{ top: 4, right: 4, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id="public-revenue-grad" x1="0" y1="0" x2="0" y2="1">
