...
export interface HotmartBuyerPayload {
  ucode?: string | null;
  name?: string | null;
  email?: string | null;
...
export interface HotmartProductPayload {
  id?: number | string | null;
  name?: string | null;
  ucode?: string | null;
}

export interface HotmartPricePayload {
  value?: number | null;
...
export interface HotmartSubscriberPayload {
  code?: string | null;
  email?: string | null;
}

export interface HotmartPlanPayload {
  name?: string | null;
  recurrence_period?: string | null;
}

export interface HotmartSubscriptionPayload {
  status?: string | null;
